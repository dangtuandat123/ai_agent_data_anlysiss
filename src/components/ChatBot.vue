<template>
    <div>
        ...
        <section style="padding: 7px; height: 100vh;" class="section_nav_bar_chat_window">
            <div v-bind:class="{ 'nav_bar_chat_window': true, 'show': isNavBarShow }">
            ...
            <div class="chat-window">
                ...
                <div class="message-window" ref="messageWindow" style="height: 100%; margin-top: 40px;">
                    <div v-show="isWelcomeMessage"
                        style="display: flex;justify-content: center; align-items: center; width: 100%; height: 100%;">
                        <a href="#top" class="logo" style="">Chào!, tôi có thể giúp gì cho bạn</a>
                    </div>


                    <component v-for="(componentData, index) in components" :key="index" :is="componentData.component"
                ...
                <div style="display: flex; justify-content: center; align-items: center; line-height: 0px;">
                    <div class="prompt_input" style="width: 60%;">
                        ...
                        <textarea id="message" name="message" placeholder="Nhập yêu cầu của bạn..." required
                            v-model="prompt" @input="adjustRows" :rows="rows"></textarea>
                    </div>
                    <!-- @keydown.enter="addMessageHuman"  -->
                    ...
                    <!-- Nút upload các file lên server -->
                ...
                <div
                    ...
                    <div class="list-file-window" style="width:60%;">
                        <div v-for="(file, index) in selectedFiles" :key="index" class="file-item"
                            style="margin: 5px 0px 5px 0px; display: flex; align-items: center;">
                            <span>{{ file.name }}</span>
                            <svg @click="removeFile(index)" class="w-6 h-6 text-gray-800 dark:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="currentColor" style="margin-left: 4px;" viewBox="0 0 24 24">
...
export default {
    ...
    data() {
        return {
            // Điều khiển trạng thái hiển thị của cửa sổ chat
            isNavBarShow: true,
            components: [],
            prompt: '',
            rows: 1,
    ...
    methods: {
        adjustRows(event) {
            ...
            // tính lineHeight (fallback nếu browser trả "normal")
            ...
            // chiều cao tối đa tương ứng maxRows
        ...
        addMessageHuman() {
            if (this.prompt !== '') {
                this.components.push({
                    ...
                    props: {
                        message: this.prompt,
                        listFile: this.selectedFiles.map(file => file.name) // Chuyển đổi danh sách file thành tên
                    }
                });
        ...
        async messageToAgent() {
            try {
                ...
                this.components.push({
                    component: 'MessageAI', // Tên của component
                    props: {
